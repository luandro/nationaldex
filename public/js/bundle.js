...
/***/ function(module, exports) {
	...
	//Create Type
	var MAKE_POKEMON = exports.MAKE_POKEMON = "MAKE_POKEMON";
	var GET_POKEMON = exports.GET_POKEMON = "GET_POKEMON";

	//Actions
	function makePokemon(name, pokemonType) {
	    return {
	        type: MAKE_POKEMON,
	        name: name,
...
/***/ function(module, exports, __webpack_require__) {
	...
	function returnStore() {
	   var store = (0, _redux.createStore)(_reducers.pokemonApp);
	   return store;
	}
